...
/*	public List<Igra> searchIgre(String gameName, String type, String location, String availability, String createdBy,
    ...
    public void s4DataLoader() {
        ...
        Igra combinedGame32 = new Igra(
            ...
            true, "Medium", "2 hours", "2024-12-10T13:00:00Z", "An interactive online escape room with live actors.", 
        ...
        Igra combinedGame35 = new Igra(
            ...
            false, "Medium", "2.5 hours", "2024-12-18T16:00:00Z", "A complex online game combining trivia, puzzles, and PvP.", 
        ...
        // Save each game
        igraRepository.saveAll(List.of(game20,game21,game22,game23,game24,game25,game26,game27,game28,game29,combinedGame30,
