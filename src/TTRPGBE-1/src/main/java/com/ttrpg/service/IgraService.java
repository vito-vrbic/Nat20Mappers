        ...
        public void s4DataLoader() {
               /* Igra game20 = new Igra(
                ...
                Igra combinedGame30 = new Igra(
                                30L, "Combined Game 30", "online", new MapLocation(45.5001, 15.978), "public",
                                "business11",
                                true, "Hard", "4 hours", "2024-12-05T19:00:00Z",
                                "An intense team-building strategy game with real-time PvP.",
                                "Rules: Work in teams to solve challenges while defending your base.", true, 8, 20,
                                "Discord", false);

                Igra combinedGame31 = new Igra(
                                31L, "Combined Game 31", "offline", new MapLocation(46.5001, 16.978), "private",
                                "business12",
                                false, "Easy", "1 hour", "2024-12-07T16:00:00Z",
                                "A mix of charades and trivia, fun for parties.",
                                "Rules: Act out clues and answer questions to score points.", true, 10, 15, "In-person",
                                true);
                ...
                Igra combinedGame33 = new Igra(
                                33L, "Combined Game 33", "online", new MapLocation(46.1001, 18.978), "private",
                                "user14",
                                true, "Hard", "3 hours", "2024-12-12T20:00:00Z",
                                "A high-stakes PvP strategy game with alliances.",
                                "Rules: Form alliances to conquer territories.", true, 6, 18, "Discord", false);

                Igra combinedGame34 = new Igra(
                                34L, "Combined Game 34", "offline", new MapLocation(44.5001, 15.878), "public",
                                "business15",
                                true, "Medium", "1.5 hours", "2024-12-15T17:00:00Z",
                                "A combination of role-playing and board game.",
                ...
                Igra combinedGame35 = new Igra(
                                ...
                                "Rules: Answer trivia, solve puzzles, and defeat the opposition.", false, 15, 40,
                                "Zoom", false);

                Igra combinedGame36 = new Igra(
                                36L, "Combined Game 36", "offline", new MapLocation(46.8001, 16.478), "private",
                                "business17",
                                true, "Hard", "3.5 hours", "2024-12-20T14:00:00Z",
                                "An immersive tabletop game with combat and puzzle-solving.",
                                "Rules: Role-play characters, defeat enemies, and solve complex puzzles.", true, 5, 15,
                                "In-person",
                                true);

                Igra combinedGame37 = new Igra(
                                37L, "Combined Game 37", "online", new MapLocation(44.6001, 15.978), "public",
                                "business18",
                                false, "Easy", "1 hour", "2024-12-22T11:00:00Z",
                                "A fast-paced trivia game with a timer.",
                                "Rules: Answer questions quickly to score the highest.", false, 10, 30, "Discord",
                                false);

                // Save each game
                igraRepository.saveAll(
                                List.of(game20, game21, game22, game23, game24, game25, game26, game27, game28, game29,
                                                combinedGame30,
                                                combinedGame31, combinedGame32, combinedGame33, combinedGame34,
                                                combinedGame35, combinedGame36,
                                                combinedGame37
